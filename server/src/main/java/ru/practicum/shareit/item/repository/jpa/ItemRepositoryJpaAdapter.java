...
public class ItemRepositoryJpaAdapter implements ItemRepository {
    ...
    @Override
    public List<Item> findAllByRequestId(Long id) {
        return jpa.findAllByRequestId(id);
    }

    @Override
    public List<Item> findAllByRequestIdIn(Collection<Long> ids) {
        return jpa.findAllByRequestIdIn(ids);
    }
