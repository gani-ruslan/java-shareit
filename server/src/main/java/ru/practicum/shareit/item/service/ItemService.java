...
public class ItemService {
    ...
    public ItemResponseDto addItem(Long ownerId, ItemCreateDto dto) {
        ...
        if (dto.requestId() != null) {
            request = requestRepository.findById(dto.requestId())
                    .orElseThrow(() -> notFound("Request", dto.requestId()));
        }

        Item savedItem = itemRepository.save(mapper.toEntity(dto, owner, request));
